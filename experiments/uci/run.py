...
import experiments.uci.benchmarks  # pylint: disable=unused-import  # Make sure registry is loaded.
import benchmark.metrics as mt
import gpflow
from experiments.uci.benchmark_api import BENCHMARK_SUITES, BenchmarkSuite, BenchmarkTask
...
from experiments.uci.plot import plot as plot_
...
def run_from_argv() -> None:
    ...
    parser.add_argument(
        ...
        "--cache-dir",
        type=Path,
        default=Path("/tmp/benchmark_data"),
